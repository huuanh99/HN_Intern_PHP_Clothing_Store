...
<div class="main">
    <div class="content">
        <div class="content_top">
            <div class="heading">
                <h3>{{ __('categories') }}: {{ $category->name }}</h3>
            </div>
            <div class="clear"></div>
        </div>
        <div class="section group">
            @foreach ($childproducts as $item)
                <div class="grid_1_of_4 images_1_of_4">
                    ...
                    <div class="button"><span><a href="{{ route('details',['id'=>$item->id]) }}" class="details">{{ __('detail') }}</a></span>
            ...
            @endforeach
            @foreach ($grandchildproducts as $item)
            <div class="grid_1_of_4 images_1_of_4">
                <a href="{{ route('details', ['id' => $item->id]) }}">
                    <img height="250" src="{{ asset('uploads') }}/{{ $item->productImages[0]->path }}" alt="" />
                </a>
